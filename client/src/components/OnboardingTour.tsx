...
const STEPS: Step[] = [
  {
    ...
    body: "У тебя 3 дня триала и 2 000 токенов в подарок: хватит на ~16 постов или 10 постов и пару анализов конкурентов. Сейчас за минуту пройдёмся по разделам — после этого начнёшь работать.",
  },
  {
    icon: BookOpen,
    eyebrow: "Раздел · Идеи",
