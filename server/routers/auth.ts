...
/* Баланс в «пользовательской» шкале (1 = 10 реальных токенов Gemini,
   см. TOKEN_DIVISOR в llm-guard.ts). 2 000 ≈ 20 000 реальных ≈
   ~16 постов или ~10 постов и пара анализов — комфортный объём,
   чтобы реально попробовать все ключевые сценарии без экономии. */
const TRIAL_TOKENS = 2_000;
